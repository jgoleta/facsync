(function () {
  const loadingId = "studentLoadingOverlay";
  ...
  function ensureLoadingOverlay() {
    ...
    overlay.innerHTML = `
      <div class="student-loading-content">
        ...
        <p id="studentLoadingMessage">Processing...</p>
      </div>
    `;
  ...
  function showLoading(message = "Processing...") {
    ...
    const messageElement = document.getElementById("studentLoadingMessage");
    loadingCount += 1;
  ...
  window.studentFeedback = { showLoading, hideLoading, showToast };
})();
